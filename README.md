...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Backend-Django-yellow" />
...
```mermaid
graph TD;
    A[User Signs Up] --> B[Add Skills Offered & Wanted];
    B --> C[AI Matches Users];
    C --> D[Connect & Schedule Session];
    D --> E[Learn & Teach];
    E --> F[Rate & Update Trust Score];
```
---
